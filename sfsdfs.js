...
<div id="table-outer">
<table><tbody>
<tr><td><label for="feed-order">Sort Songs by:</label></td> <td><select id="feed-order"> <option selected="" value="published">The latest Songs</option> <option value="updated">The last Song Published</option> </select></td></tr>
<tr><td><label for="label-sorter">Filter Songs by category:</label></td> <td><select disabled="" id="label-sorter"> <option selected="">Loading....</option> </select></td></tr>
<tr>                 <td><label for="feed-q">Search Songs Below</label></td> <td><form id="post-searcher">
<input id="feed-q" type="text" placeholder="Press Enter To Search"/>
</form>
</td></tr>
</tbody></table>
</div>
...
init: function(){var cfg={homePage:getQueryVariable("url"),maxResults:15,numChars:0,thumbWidth:140,thumbHeight:95,navText:"Load More Songs &#9660;",resetToc:"Back To Top",noImage:"https://4.bp.blogspot.com/-OzZJe9P-Un0/WprfR1PjBEI/AAAAAAAAXt8/7OnhfRVQPP4LHwa4PUxeTFodkA-adshfgCLcBGAs/s1600/no-imagen.png",loading:"<span>Loading...</span>",counting:"<div>Loading Songs</div>",searching:"<span>Search...</span>"
...
var _h;o.g.innerHTML="";o.e.innerHTML=o.l==1?'<span>Search Results For Songs<b>&#8220;'+ o.m+'&#8221;</b> ('+ json.feed.openSearch$totalResults.$t+' Hasil)</span>': '<div>Total: '+ json.feed.openSearch$totalResults.$t+' Artículos</div>';
